...
----------- Insert Mode -----------------
-- use jk to exit insert mode, jk recommended
keymap.set("i", "jk", "<ESC>")
...
-- bufferline
keymap.set("n", "<C-I>", ":BufferLineCyclePrev<CR>") --({ nnoremap = true, silent = true }) --":bnext<CR>")
keymap.set("n", "<C-O>", ":BufferLineCycleNext<CR>") --({ nnoremap = true, silent = true }) --":bprevious<CR>")
-- 切换buffer
